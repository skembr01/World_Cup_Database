...
--
-- Name: games opponentid_teamid; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT opponentid_teamid FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games winnerid_teamid; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT winnerid_teamid FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
